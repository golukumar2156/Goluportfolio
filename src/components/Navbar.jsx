  ...
  return (
    <div className="fixed top-0 left-0 w-full z-50">
     ...
     {/* END: */}
        ...
        <ul className={`md:hidden duration-700 bg-gradient-to-r from-[#1E293B] to-[#0F766E] p-[15px] fixed right-0 w-[200px] h-[100%]  text-yellow-400 top-[60px]  ${toggle ? "right-[0]" : "right-[-100%]" }`}>
              <li>
           <NavLink to="/"  className={({ isActive }) =>
          isActive ? "bg-blue-500 font-bold px-[10px] py-[2px] rounded-lg duration-700" : "text-black"
        }>Home</NavLink>
